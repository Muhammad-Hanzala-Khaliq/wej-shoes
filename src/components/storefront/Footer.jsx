...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "var(--ink)", color: "#a8a29e" }}>
      <div className="container-page py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-display text-lg font-bold mb-4" style={{ color: "#fff" }}>{storeName}</h3>
            ...
            <div className="flex gap-4">
              <a href="#" style={{ color: "#a8a29e" }} className="hover:opacity-80 transition-opacity">
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: "#fff" }}>Customer Service</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: "#fff" }}>Contact Us</h4>
