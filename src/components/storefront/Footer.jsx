    ...
    <footer style={{ background: "var(--ink)", color: "#a3a3a3" }}>
      <div className="container-page py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-display text-lg font-bold mb-4" style={{ color: "var(--bg)" }}>{storeName}</h3>
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: "var(--bg)" }}>Quick Links</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: "var(--bg)" }}>Customer Service</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: "var(--bg)" }}>Contact Us</h4>
